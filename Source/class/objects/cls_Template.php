...
class Template
{
	...
	public function render($WithoutHeader=false)
	{
		echo $this->renderWithoutSend(true, $WithoutHeader);
	}
	 ...
	 * @param bool $WithoutHeader gibt an ob der Header gesendet wird oder im Fehlerfall nicht
	 * @return string 
	 *
	 */
	public function renderWithoutSend($LanguageParsing=true,$WithoutHeader=false)
	{
		if ( $WithoutHeader == false ) header('content-type: text/html; charset=utf-8');
		ob_start();
		if($this->Content)
		{
