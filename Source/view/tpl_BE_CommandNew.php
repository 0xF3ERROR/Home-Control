			...
			<div id='m_m_1_sp_inhalt' align='center'>
				...
				<div id='Befehle_anzeigen'>
					<div class='gruppenkontainer'>
						<form action='index.php?Section=Commands&amp;Action=addNewCommand' name='form' method='POST' target=''>
							<fieldset class='BIM_Group_fieldset'>
								<legend>:T_COMMAND_DATA:</legend>
								<div class='befehlskontainer' >			
									:T_COMMAND_NAME:: <input type='Text' name='tb_CommandName' value='' size='' maxlength='25'>
								</div>";							

// Geräte Auflisten


// Befehle für geräte anzeigen
